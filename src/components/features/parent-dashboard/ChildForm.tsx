          ...
          <DialogBody className="space-y-5">
            ...
            <div>
              ...
              <Input
                ...
                className="mt-1 h-11 border-amber-700/50 bg-amber-900/50 text-amber-100 placeholder:text-amber-500 focus-visible:ring-2 focus-visible:ring-amber-400"
                autoFocus
              />
            </div>
                ...
                {iconKeys.map((key) => {
                  ...
                  return (
                    <button
                      ...
                      // F20: each icon tile is now ≥44×44 (min-h-[60px] gives
                      // emoji + label two rows of breathing room).
                      className={`flex min-h-[60px] flex-col items-center justify-center gap-1 rounded-xl p-3 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 ${
                        isSelected
