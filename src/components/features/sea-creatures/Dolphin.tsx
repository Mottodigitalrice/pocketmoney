    ...
    <svg viewBox="0 0 140 70" className={className} width="110" height="55">
      ...
      <g
        style={{
          ...
          animation: "dolph-body 2s ease-in-out infinite",
        }}
      >
        <path
      ...
      <g
        style={{
          ...
          animation: "dolph-dorsal 2.5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "25px 38px",
          animation: "dolph-tail 0.7s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "dolph-pec 1.8s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "116px 34px",
          animation: "dolph-blink 5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "126px 42px",
          animation: "dolph-smile 3s ease-in-out infinite",
        }}
      >
        <path
          d="M118,40 Q125,46 135,39"
          stroke="#0D47A1"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
