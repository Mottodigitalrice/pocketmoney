    ...
    <svg viewBox="0 0 80 80" className={className} width="60" height="60">
      ...
      <g
        style={{
          ...
          animation: "star-blink 5s ease-in-out infinite 0.15s",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "star-bump 2s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "star-bump 2s ease-in-out infinite 0.4s",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "star-bump 2s ease-in-out infinite 0.8s",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "star-bump 2s ease-in-out infinite 1.2s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "15px 28px",
          animation: "star-bump 2s ease-in-out infinite 1.6s",
        }}
      >
