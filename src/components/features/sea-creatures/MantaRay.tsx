    ...
    <svg viewBox="0 0 150 80" className={className} width="120" height="64">
      ...
      <g
        style={{
          ...
          animation: "manta-wing-l 2s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "75px 40px",
          animation: "manta-wing-r 2s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "manta-ceph 2.5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "85px 32px",
          animation: "manta-ceph 2.5s ease-in-out infinite 0.2s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "67px 36px",
          animation: "manta-blink 5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "manta-blink 5s ease-in-out infinite 0.3s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "75px 54px",
          animation: "manta-tail 1s ease-in-out infinite",
        }}
      >
