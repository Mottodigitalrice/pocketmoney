...
export function Shark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 140 70" className={className} width="120" height="60">
      ...
      <g
        style={{
          transformOrigin: "70px 16px",
          animation: "shark-dorsal 2s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "shark-tail 0.8s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "85px 48px",
          animation: "shark-pec 1.5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "shark-pec 1.5s ease-in-out infinite 0.3s",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "shark-eye-blink 4s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "118px 44px",
          animation: "shark-jaw 1.2s ease-in-out infinite",
        }}
      >
        <path
          d="M108,44 Q118,52 128,42"
          stroke="#263238"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M112,44 L113,47 L114,44"
          fill="white"
          stroke="#263238"
          strokeWidth="0.5"
        />
        <path
          d="M117,46 L118,49 L119,46"
          fill="white"
          stroke="#263238"
          strokeWidth="0.5"
        />
        <path
          d="M122,45 L123,48 L124,45"
          fill="white"
          stroke="#263238"
          strokeWidth="0.5"
        />
