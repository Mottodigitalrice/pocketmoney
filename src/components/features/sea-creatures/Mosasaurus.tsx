    ...
    <svg viewBox="0 0 160 70" className={className} width="130" height="57">
      ...
      <g
        style={{
          ...
          animation: "mosa-body 2.5s ease-in-out infinite",
        }}
      >
        <path
      ...
      <g
        style={{
          transformOrigin: "55px 26px",
          animation: "mosa-ridge 1.5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "mosa-ridge 1.5s ease-in-out infinite 0.2s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "84px 26px",
          animation: "mosa-ridge 1.5s ease-in-out infinite 0.4s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "15px 36px",
          animation: "mosa-tail 0.6s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "mosa-flip 1.8s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "mosa-flip 1.8s ease-in-out infinite 0.4s",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "139px 35px",
          animation: "mosa-blink 3.5s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          transformOrigin: "148px 42px",
          animation: "mosa-jaw 1s ease-in-out infinite",
        }}
      >
        <path
          d="M142,42 Q150,46 157,40"
          stroke="#4A148C"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
