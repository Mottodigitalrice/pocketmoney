...
export function SnappingTurtle({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 80" className={className} width="100" height="67">
      ...
      {/* Shell scutes */}
      <path
        d="M50,22 Q60,18 70,22"
        stroke="#4E342E"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M42,32 Q60,26 78,32"
        stroke="#4E342E"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M38,42 Q60,36 82,42"
        stroke="#4E342E"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M42,52 Q60,48 78,52"
        stroke="#4E342E"
        strokeWidth="1.5"
        fill="none"
      />
      ...
      <g
        style={{
          transformOrigin: "98px 40px",
          animation: "snap-head 2s ease-in-out infinite",
        }}
      >
        ...
        <g
          style={{
            ...
            animation: "snap-jaw 2s ease-in-out infinite",
          }}
        >
        ...
        <g
          style={{
            transformOrigin: "103px 34px",
            animation: "snap-blink 4s ease-in-out infinite",
          }}
        >
      ...
      <g
        style={{
          ...
          animation: "snap-leg-fl 1s ease-in-out infinite",
        }}
      >
        <ellipse
          cx="38"
      ...
      <g
        style={{
          transformOrigin: "75px 32px",
          animation: "snap-leg-fr 1s ease-in-out infinite 0.15s",
        }}
      >
        <ellipse
          cx="82"
      ...
      <g
        style={{
          transformOrigin: "42px 53px",
          animation: "snap-leg-bl 1.3s ease-in-out infinite 0.3s",
        }}
      >
        <ellipse
          cx="35"
          ...
          ry="6"
          fill="#8D6E63"
          transform="rotate(15 35 56)"
        />
      </g>
      {/* Back right leg */}
      <g
        style={{
          transformOrigin: "78px 53px",
          animation: "snap-leg-br 1.3s ease-in-out infinite 0.45s",
        }}
      >
        <ellipse
          cx="85"
          ...
          ry="6"
          fill="#8D6E63"
          transform="rotate(-15 85 56)"
        />
      </g>
      {/* Spiky tail */}
      <g
        style={{
          transformOrigin: "25px 42px",
          animation: "snap-tail 0.8s ease-in-out infinite",
        }}
      >
        <path
          d="M25,42 L10,38 L14,42 L8,44 L15,44 L12,48 L25,42"
          fill="#8D6E63"
        />
      </g>
    </svg>
