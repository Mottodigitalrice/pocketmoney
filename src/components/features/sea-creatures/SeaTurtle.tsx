...
export function SeaTurtle({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 80" className={className} width="100" height="67">
      ...
      {/* Shell pattern */}
      <path
        d="M45,30 Q60,25 75,30"
        stroke="#388E3C"
        strokeWidth="2"
        fill="none"
      />
      <path
        d="M42,42 Q60,35 78,42"
        stroke="#388E3C"
        strokeWidth="2"
        fill="none"
      />
      <path
        d="M45,52 Q60,48 75,52"
        stroke="#388E3C"
        strokeWidth="2"
        fill="none"
      />
      ...
      <g
        style={{
          transformOrigin: "95px 38px",
          animation: "turtle-head 3s ease-in-out infinite",
        }}
      >
      ...
      <g
        style={{
          ...
          animation: "turtle-fl 1.2s ease-in-out infinite",
        }}
      >
        <ellipse
          cx="38"
      ...
      <g
        style={{
          ...
          animation: "turtle-fr 1.2s ease-in-out infinite 0.15s",
        }}
      >
        <ellipse
          cx="82"
          ...
          ry="6"
          fill="#81C784"
          transform="rotate(30 82 25)"
        />
      </g>
      {/* Back left flipper */}
      <g
        style={{
          transformOrigin: "45px 55px",
          animation: "turtle-bl 1.5s ease-in-out infinite 0.3s",
        }}
      >
        <ellipse
          cx="35"
      ...
      <g
        style={{
          ...
          animation: "turtle-br 1.5s ease-in-out infinite 0.45s",
        }}
      >
        <ellipse
          cx="85"
      ...
      <g
        style={{
          ...
          animation: "turtle-tail 1s ease-in-out infinite",
        }}
      >
